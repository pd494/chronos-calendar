...
export function EventsProvider({ children }: EventsProviderProps) {
  ...
  const {
    ...
    // Only start hydration + initial sync after calendars have been fetched after mount.
    // This avoids syncing with stale persisted calendar IDs.
    enabled:
      visibleCalendarIds.length > 0 && calendarsQuery.isFetchedAfterMount,
  });
